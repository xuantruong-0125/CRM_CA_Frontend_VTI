...
export function KeyboardShortcutBadge({
  ...
  return (
    <kbd
      className={`inline-flex items-center rounded-md border border-sky-200 bg-sky-50 px-1.5 py-0.5 text-[8px] font-semibold text-sky-700 shadow-sm ${className} ${usesSolidWhiteBackground ? "text-black" : ""}`}
