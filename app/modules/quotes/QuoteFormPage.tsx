...
export default function QuoteFormPage({ mode }: Props) {
    ...
    useEffect(() => {
        ...
        setIsSales(user?.roles.includes("SALE") ?? false);
    }, []);
    ...
    const canSubmit = !!formData.customerId && formData.lineItems.some(i => i.productId !== "");
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSave} className={styles.formLayout} onKeyDown={handleFormKeyDown}>
                {/* Top: info + summary */}
                <div className={styles.formTopGrid}>
                        ...
                        <div className={styles.formFieldsGrid}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                >
                                    ...
                                    {!isSales && <option value={3}>Chấp nhận</option>}
                                    {!isSales && <option value={4}>Đã hủy</option>}
                                </select>
                            </div>
                    ...
                    <div className={styles.summaryCard}>
                        ...
                        <button type="submit" className={styles.btnSave} disabled={saving || !canSubmit}>
